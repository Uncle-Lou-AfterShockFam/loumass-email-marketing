      ...
      <div className="space-y-6">
        ...
        <div className="space-y-3">
          <label className="flex items-center">
            ...
            <span className="ml-3">
              ...
              <span className="block text-sm text-gray-500">Campaign will be sent as soon as you save</span>
            </span>
          </label>
          ...
          <label className="flex items-center">
            ...
            <span className="ml-3">
              ...
              <span className="block text-sm text-gray-500">Choose a specific date and time</span>
            </span>
          </label>
        </div>
        ...
        {scheduleType === 'later' && (
          <div className="space-y-4 pl-7">
            ...
            <div>
              <label htmlFor="customDateTime" className="block text-sm font-medium text-gray-700 mb-2">
